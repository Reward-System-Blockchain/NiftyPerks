  ...
  items: [
    {
      id: "0p0x1",
      title: "Earn & Burn",
      text: "Encourage repeat purchase and improve customer loyalty by introducing points-based loyalty program that rewards customers for specific behaviors.", 
    ...
    },
    {
      ...
      text: "Encourage customers to spend more by enticing them with incremental benefits in order to reach the next level and unlock additional rewards.",
...
const footerAPI = {
  titles: [ {title: "About NiftyPerks"},{title: "Get Help"},{title: "Company"} ],
  links: [
    [
      {link: "Prupose"},
      {link: "News"},
